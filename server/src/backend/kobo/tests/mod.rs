...
/// same shapes `docs/kobo.md` documents as inferred rather than taken from a
/// packet capture. Passing here does not prove a device's firmware accepts
/// what is sent — only a real Kobo can.
///
