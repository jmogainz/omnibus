...
- **Risks.** Undocumented protocol; another implementation's implementation is our reference. Scope to "parity with another implementation minus 100-item cap" for v1.0.
