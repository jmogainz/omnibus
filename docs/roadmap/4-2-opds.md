...
- Route layout mirrors another implementation's for client compatibility (see [calibre-inspection §2](../calibre-inspection/2-feature-inventory.md), [§6](../calibre-inspection/6-api-surface.md)): `/opds`, `/opds/osd`, `/opds/search`, `/opds/new`, letter-indexed author/series/category browses, per-entity endpoints, download, cover.
