...
Self-hosted operators have no Datadog, no PagerDuty. The admin health page IS observability for them. another implementation's lack of this is the most-cited reason its operators move to AudioBookShelf.
