...
another implementation expect publisher and language filters, and the population
...
- **Facet picker data source.** Add taxonomy-listing queries to
  ...
  result counts next to each option (another implementation's faceted browse does
