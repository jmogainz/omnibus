...
Stats are the moment users *show* the app to a friend. They're also the closing-loop on the reading habit — seeing yourself read 2 hours/day for 8 weeks is the reason a user stays self-hosted instead of going back to Kindle. another implementation has no equivalent.
