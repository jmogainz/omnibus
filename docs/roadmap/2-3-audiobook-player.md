...
Audiobook support is the feature AudioBookShelf users currently leave for — lacking it would make Omnibus "just another another implementation." Ships alongside the epub reader so the library is meaningful for both mediums from Phase 2.
