...
([another implementation's `cps/kobo.py`](https://github.com/another-project/another-implementation/blob/master/cps/kobo.py)):
...
another implementation complaint ([#2155](https://github.com/another-project/another-implementation/issues/2155)).
...
- **Do not confuse this with wireless sync, which *deletes* annotations.**
  ...
  annotations** ([#2610](https://github.com/another-project/another-implementation/issues/2610),
  [#1783](https://github.com/another-project/another-implementation/issues/1783)). If F4.1
