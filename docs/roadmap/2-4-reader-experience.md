...
F2.2 proves a book can be read in the browser; F2.4 makes reading something a user *wants* to do in Omnibus. Immersive chrome, real typography, and the highlight→quote flow are the difference between parity-with-another implementation and a reader people prefer.
