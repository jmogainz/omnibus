...
Closes a real another implementation parity gap for power users. Gives them AZW3, PDF, TXT, FB2, etc. without leaving Omnibus. **Post-v1.0 unless user demand appears** — most users asking for format conversion already have Calibre installed and can convert there.
