...
Supersedes the prior root-level `ROADMAP.md`. Synthesizes the v1 feature list with the [another implementation inspection](../calibre-inspection/0-overview.md), reorganized to reflect the foundational work v1 assumed but did not sequence, and to incorporate performance lessons learned from another implementation.
...
The [another implementation inspection](../calibre-inspection/0-overview.md) reveals three classes of issue we can avoid if we act early:
...
- [another implementation inspection](../calibre-inspection/0-overview.md) — source-level study of the tool we're replacing.
