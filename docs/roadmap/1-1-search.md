...
The feature another implementation users most complain about (see [calibre-inspection §2](../calibre-inspection/2-feature-inventory.md) — another implementation's default search is `LIKE '%q%'`, no tokenization, no ranking). Closes [gap G1](0-0-summary.md#gaps). Cheap to ship on top of F0.4.
